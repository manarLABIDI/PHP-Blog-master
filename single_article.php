...
<body>
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/fr_FR/sdk.js#xfbml=1&version=v15.0" nonce="Iqs4fiLg"></script>
    <!-- Header -->
    ...
    <main role="main" class="bg-l py-4">
        ...
        <div class="container">
            ...
            function showResult(int){
                                ...
                                xmlhttp.open("GET","livesearch.php?q="+int,true);
                                xmlhttp.send();
                            }
                            </script>
                        ...
                        <?php foreach ($comments as $comment) : ?>
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="fb-like" data-href="http://localhost:7882/demos/PHP-Blog-master/index.php" data-width="" data-layout="button_count" data-action="like" data-size="small" data-share="false"></div>
                                </div>
                            </div>
