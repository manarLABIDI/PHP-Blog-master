        ...
        <div class="jumbotron text-center p-0 mb-0">
            <div class="bg-div px-5 d-flex align-items-center">
                ...
                <div class="text-left w-50">
                    <h1 class="display-4 text-white">Welcome to World Cup 2022!</h1>
                    <h2 class="display-5 text-white">Discover  articles that you can read completely for free!</h2>
...
<!-- end Gist JS code-->
            ...
            <div class="container">
                ...
                <form>
                                <h2> Search </h2>
                            <input type="text" size="30"placeholder="Enter full tag to search" onkeyup="showResult(this.value)">
